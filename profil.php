...
<div class="container">
    ...
    <p><img src="uploads/<?php echo htmlspecialchars($user['photo']); ?>" alt="Photo de profil"></p>
        <p>Civilite: <?php echo htmlspecialchars($user['gender']); ?></p>
        <p>Nom complet: <?php echo htmlspecialchars($user['firstname'] . ' ' . $user['lastname']); ?></p>
        <p>Adresse: <?php echo htmlspecialchars($user['address']); ?></p>
        <p>Téléphone: <?php echo htmlspecialchars($user['user_mobile']); ?></p>
        <p>Email: <?php echo htmlspecialchars($user['email']); ?></p>
        <p>Code Postal: <?php echo htmlspecialchars($user['zip']); ?></p>
        <p>Date de Naissance: <?php echo htmlspecialchars($user['birth']); ?></p>
        <p>Ville: <?php echo htmlspecialchars($user['lang']); ?></p>
